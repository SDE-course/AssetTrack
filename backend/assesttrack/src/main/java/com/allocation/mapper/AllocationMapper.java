...
public class AllocationMapper {
    ...
    public AllocationResponse toResponse(Allocation a) {
        return AllocationResponse.builder()
            ...
            .assignedToName(a.getAssignedTo().getFullName())
    ...
    public AllocationHistoryResponse toHistoryResponse(Allocation a) {
        return AllocationHistoryResponse.builder()
            ...
            .user(a.getAssignedTo().getFullName())
                .userId(a.getAssignedTo().getId())
            .assignedBy(a.getAssignedBy().getFullName())
                .assignedDate(a.getAssignedDate())
                .returnedDate(a.getReturnedDate())
                .active(a.isActive())
                .notes(a.getNotes())
    ...
    public SpareLaptopResponse toSpareLaptopResponse(Asset asset) {
        return SpareLaptopResponse.builder()
                .id(asset.getId())
                .name(asset.getName())
